...
train5.py
Vikram Narayan
Applies the successful train3.py in an attempt to fix train4.py
"""
# system imports
import pdb
import random
...
if __name__=='__main__':
    ...
    for i in ['beginning', 'middle','end']:
        curr_node = hierarchicalHMM.node_dict[i+'0']

        eof_node = hierarchicalHMM.get_eof_state(curr_node)
        curr_node.horizontal_transitions[eof_node]=1
        for note in ['0','72','74','76','77','79']:
            curr_node.horizontal_transitions[hierarchicalHMM.node_dict[i+note]]=0
    ...
    hmm = HMM(hierarchicalHMM, 'toy3.data')
